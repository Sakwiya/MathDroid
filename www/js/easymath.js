...
function submitquiz() {
	...
	if(answer1 == trueanswer1)
	{
         ...
         $("#res_your_1").addClass('correct');
    }else{
         $("#res_your_1").addClass('wrong');
    }
	...
	if(answer2 == trueanswer2)
	{
         ...
         $("#res_your_2").addClass('correct');
    }else{
         $("#res_your_2").addClass('wrong');
    }
	...
	if(answer3 == trueanswer3)
	{
         ...
         $("#res_your_3").addClass('correct');
    }else{
         $("#res_your_3").addClass('wrong');
    }
	...
	if(answer4 == trueanswer4)
	{
         ...
         $("#res_your_4").addClass('correct');
    }else{
         $("#res_your_4").addClass('wrong');
    }
	...
	if(answer5 == trueanswer5)
	{
         ...
         $("#res_your_5").addClass('correct');
    }else{
         $("#res_your_5").addClass('wrong');
    }
	...
	if(answer6 == trueanswer6)
	{
         ...
         $("#res_your_6").addClass('correct');
    }else{
         $("#res_your_6").addClass('wrong');
    }
	...
	if(answer7 == trueanswer7)
	{
         ...
         $("#res_your_7").addClass('correct');
    }else{
         $("#res_your_7").addClass('wrong');
    }
	...
	if(answer8 == trueanswer8)
	{
         ...
         $("#res_your_8").addClass('correct');
    }else{
         $("#res_your_8").addClass('wrong');
    }
	...
	if(answer9 == trueanswer9)
	{
         ...
         $("#res_your_9").addClass('correct');
    }else{
         $("#res_your_9").addClass('wrong');
    }
	...
	if(answer10 == trueanswer10)
	{
         ...
         $("#res_your_10").addClass('correct');
    }else{
         $("#res_your_10").addClass('wrong');
    }
	...
	$('#game_rate').addClass('correct');
	} else {
    rating = "Study Hard";
	$('#game_rate').addClass('wrong');
	}
		
	$('#game_rate').text(rating);
